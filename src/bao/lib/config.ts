...
export default {
	...
	contracts: {
		...
		BaoClaim: {
			1: {
				address: '0x14c128A14B00855Eb561d1f9da342962fafBfdCc',
			},
		},
		Swapper: {
			1: {
	...
	baskets: [
		...
		},
		{
			...
			recipeAddress: '0x0000000000000000000000000000000000000000',
			recipeVersion: 1,
			ovenAddress: '0x0000000000000000000000000000000000000000',
			symbol: 'bETH',
			name: 'bETH',
			icon: 'bETH.png',
			cgIds: {},
			pieColors: {},
			desc: 'Ethereum basket',
		},
		{
			nid: 2,
			basketAddresses: {
			...
			lpAddress: '0x0000000000000000000000000000000000000000', // TODO: Update with actual LP address
			recipeAddress: '0x0000000000000000000000000000000000000000', // TODO: Update with actual recipe address
			recipeVersion: 1,
			ovenAddress: '0x0000000000000000000000000000000000000000', // TODO: Update with actual oven address
			symbol: 'nDEFI',
			name: 'nDEFI',
			icon: 'ndefi.svg',
			cgIds: {
		...
		},
		{
			...
			desc: 'Stablecoin nest on Polygon',
		},
		{
			nid: 4,
			basketAddresses: {
			...
			desc: 'Infrastructure nest on Polygon',
		},
		{
			nid: 5,
			basketAddresses: {
