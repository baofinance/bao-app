...
export declare namespace IPoolSwapStructs {
	...
	export type SwapRequestStructOutput = [number, string, string, BigNumber, string, BigNumber, string, string, string] & {
		kind: number
		tokenIn: string
		tokenOut: string
		amount: BigNumber
...
export interface BalancerComposableStablePoolInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'getProtocolFeePercentageCache(uint256)', values: [PromiseOrValue<BigNumberish>]): string
	...
	encodeFunctionData(functionFragment: 'getTokenRate(address)', values: [PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'getTokenRateCache', values: [PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'getTokenRateCache(address)', values: [PromiseOrValue<string>]): string
	...
	encodeFunctionData(functionFragment: 'isTokenExemptFromYieldProtocolFee(address)', values: [PromiseOrValue<string>]): string
	...
	encodeFunctionData(functionFragment: 'setSwapFeePercentage(uint256)', values: [PromiseOrValue<BigNumberish>]): string
	encodeFunctionData(functionFragment: 'setTokenRateCacheDuration', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string
	encodeFunctionData(
	...
	encodeFunctionData(functionFragment: 'updateTokenRateCache(address)', values: [PromiseOrValue<string>]): string
	...
	decodeFunctionResult(functionFragment: 'getProtocolFeePercentageCache(uint256)', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'getTokenRate(address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'getTokenRateCache', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'getTokenRateCache(address)', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'isTokenExemptFromYieldProtocolFee(address)', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'onExitPool(bytes32,address,address,uint256[],uint256,uint256,bytes)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'onJoinPool', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'onJoinPool(bytes32,address,address,uint256[],uint256,uint256,bytes)', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'queryExit(bytes32,address,address,uint256[],uint256,uint256,bytes)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'queryJoin', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'queryJoin(bytes32,address,address,uint256[],uint256,uint256,bytes)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'setAssetManagerPoolConfig', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'setAssetManagerPoolConfig(address,bytes)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'setSwapFeePercentage', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'setSwapFeePercentage(uint256)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'setTokenRateCacheDuration', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'setTokenRateCacheDuration(address,uint256)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'startAmplificationParameterUpdate', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'startAmplificationParameterUpdate(uint256,uint256)', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'updateTokenRateCache(address)', data: BytesLike): Result
	...
	getEvent(nameOrSignatureOrTopic: 'AmpUpdateStarted(uint256,uint256,uint256,uint256)'): EventFragment
	...
	getEvent(nameOrSignatureOrTopic: 'ProtocolFeePercentageCacheUpdated(uint256,uint256)'): EventFragment
	getEvent(nameOrSignatureOrTopic: 'RecoveryModeStateChanged'): EventFragment
	getEvent(nameOrSignatureOrTopic: 'RecoveryModeStateChanged(bool)'): EventFragment
	getEvent(nameOrSignatureOrTopic: 'SwapFeePercentageChanged'): EventFragment
	getEvent(nameOrSignatureOrTopic: 'SwapFeePercentageChanged(uint256)'): EventFragment
	getEvent(nameOrSignatureOrTopic: 'TokenRateCacheUpdated'): EventFragment
	getEvent(nameOrSignatureOrTopic: 'TokenRateCacheUpdated(uint256,uint256)'): EventFragment
	getEvent(nameOrSignatureOrTopic: 'TokenRateProviderSet'): EventFragment
	getEvent(nameOrSignatureOrTopic: 'TokenRateProviderSet(uint256,address,uint256)'): EventFragment
...
export type AmpUpdateStartedEvent = TypedEvent<[BigNumber, BigNumber, BigNumber, BigNumber], AmpUpdateStartedEventObject>
...
export type ProtocolFeePercentageCacheUpdatedEvent = TypedEvent<[BigNumber, BigNumber], ProtocolFeePercentageCacheUpdatedEventObject>
...
export interface BalancerComposableStablePool extends BaseContract {
	...
	functions: {
		...
		'getNextNonce(address)'(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>
		...
		'getProtocolFeePercentageCache(uint256)'(feeType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>
		...
		'getTokenRate(address)'(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>
		...
		'isTokenExemptFromYieldProtocolFee(address)'(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>
		...
		stopAmplificationParameterUpdate(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
		...
		updateProtocolFeePercentageCache(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
	...
	callStatic: {
		...
		'setSwapFeePercentage(uint256)'(swapFeePercentage: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>
		...
		'updateTokenRateCache(address)'(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>
	...
	filters: {
		...
		TokenRateCacheUpdated(tokenIndex?: PromiseOrValue<BigNumberish> | null, rate?: null): TokenRateCacheUpdatedEventFilter
	...
	estimateGas: {
		...
		'getTokenRateCache(address)'(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>
		...
		'isTokenExemptFromYieldProtocolFee(address)'(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>
		...
		updateTokenRateCache(token: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
	...
	populateTransaction: {
		...
		'getNextNonce(address)'(account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>
		...
		getProtocolFeePercentageCache(feeType: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>
		...
		'getTokenRate(address)'(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>

		getTokenRateCache(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>

		'getTokenRateCache(address)'(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>
		...
		'isTokenExemptFromYieldProtocolFee(address)'(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>
		...
		stopAmplificationParameterUpdate(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
		...
		updateProtocolFeePercentageCache(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
