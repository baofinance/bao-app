...
export interface CetherInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'liquidateBorrow(address,address)', values: [PromiseOrValue<string>, PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'mint', values: [PromiseOrValue<boolean>]): string
	encodeFunctionData(functionFragment: 'mint(bool)', values: [PromiseOrValue<boolean>]): string
	...
	encodeFunctionData(functionFragment: 'repayBorrowBehalf(address)', values: [PromiseOrValue<string>]): string
	...
	decodeFunctionResult(functionFragment: 'liquidateBorrow(address,address)', data: BytesLike): Result
	...
	decodeFunctionResult(functionFragment: 'repayBorrowBehalf(address)', data: BytesLike): Result
...
export interface Cether extends BaseContract {
	...
	mint(enterMarket: PromiseOrValue<boolean>, overrides?: PayableOverrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
	...
	callStatic: {
		...
		mint(enterMarket: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>

		'mint(bool)'(enterMarket: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>
		...
		'repayBorrowBehalf(address)'(borrower: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>
	...
	estimateGas: {
		...
		balanceOfUnderlying(owner: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
		...
		mint(enterMarket: PromiseOrValue<boolean>, overrides?: PayableOverrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>

		'mint(bool)'(enterMarket: PromiseOrValue<boolean>, overrides?: PayableOverrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
