...
export interface CurveLpInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'mint_relative', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string
	encodeFunctionData(
	...
	decodeFunctionResult(functionFragment: 'mint_relative', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'mint_relative(address,uint256)', data: BytesLike): Result
...
export interface CurveLp extends BaseContract {
	...
	callStatic: {
		...
		mint_relative(_to: PromiseOrValue<string>, frac: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>
		...
		burnFrom(_to: PromiseOrValue<string>, _value: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<boolean>
