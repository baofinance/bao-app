...
export interface DecimalWrapperInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'conversion', values?: undefined): string
	encodeFunctionData(functionFragment: 'conversion()', values?: undefined): string
...
export interface DecimalWrapper extends BaseContract {
	...
	callStatic: {
		...
		'withdraw(uint256)'(_amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>
	}
	...
	estimateGas: {
		...
		'deposit(uint256)'(_amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
