...
export declare namespace CompoundLens {
	...
	export type CTokenBalancesStructOutput = [string, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber, BigNumber] & {
		cToken: string
		balanceOf: BigNumber
...
export interface LensInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'cTokenBalances(address,address)', values: [PromiseOrValue<string>, PromiseOrValue<string>]): string
	...
	encodeFunctionData(functionFragment: 'cTokenMetadata(address)', values: [PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'cTokenMetadataAll', values: [PromiseOrValue<string>[]]): string
	encodeFunctionData(functionFragment: 'cTokenMetadataAll(address[])', values: [PromiseOrValue<string>[]]): string
	encodeFunctionData(functionFragment: 'cTokenUnderlyingPrice', values: [PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'cTokenUnderlyingPrice(address)', values: [PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'cTokenUnderlyingPriceAll', values: [PromiseOrValue<string>[]]): string
	encodeFunctionData(functionFragment: 'cTokenUnderlyingPriceAll(address[])', values: [PromiseOrValue<string>[]]): string
	...
	decodeFunctionResult(functionFragment: 'cTokenBalances(address,address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenBalancesAll', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenBalancesAll(address[],address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenMetadata', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenMetadata(address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenMetadataAll', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenMetadataAll(address[])', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenUnderlyingPrice', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenUnderlyingPrice(address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenUnderlyingPriceAll', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'cTokenUnderlyingPriceAll(address[])', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'getAccountLimits', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'getAccountLimits(address,address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'getClaimableCompRewards', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'getClaimableCompRewards(address[],address,address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'getClaimableSushiRewards', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'getClaimableSushiRewards(address[],address,address)', data: BytesLike): Result
...
export interface Lens extends BaseContract {
	...
	functions: {
		...
		cTokenMetadata(cToken: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
	...
	callStatic: {
		...
		'cTokenMetadata(address)'(cToken: PromiseOrValue<string>, overrides?: CallOverrides): Promise<CompoundLens.CTokenMetadataStructOutput>
	...
	estimateGas: {
		...
		cTokenMetadata(cToken: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>

		'cTokenMetadata(address)'(cToken: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>

		cTokenMetadataAll(cTokens: PromiseOrValue<string>[], overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
		...
		cTokenUnderlyingPrice(cToken: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
	...
	populateTransaction: {
		...
		cTokenMetadata(cToken: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
