...
export interface MinterInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'mint_many(address[8])', values: [PromiseOrValue<string>[]]): string
	encodeFunctionData(functionFragment: 'mint_for', values: [PromiseOrValue<string>, PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'mint_for(address,address)', values: [PromiseOrValue<string>, PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'toggle_approve_mint', values: [PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'toggle_approve_mint(address)', values: [PromiseOrValue<string>]): string
	...
	encodeFunctionData(functionFragment: 'minted(address,address)', values: [PromiseOrValue<string>, PromiseOrValue<string>]): string
	...
	decodeFunctionResult(functionFragment: 'mint_many(address[8])', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'mint_for', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'mint_for(address,address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'toggle_approve_mint', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'toggle_approve_mint(address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'token', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'token()', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'controller', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'controller()', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'minted', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'minted(address,address)', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'allowed_to_mint_for', data: BytesLike): Result
	decodeFunctionResult(functionFragment: 'allowed_to_mint_for(address,address)', data: BytesLike): Result
	...
	getEvent(nameOrSignatureOrTopic: 'Minted(address,address,uint256)'): EventFragment
}
...
export interface Minter extends BaseContract {
	...
	functions: {
		mint(gauge_addr: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
		...
		'minted(address,address)'(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>
	...
	mint_many(gauge_addrs: PromiseOrValue<string>[], overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
	...
	callStatic: {
		...
		'mint(address)'(gauge_addr: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>

		mint_many(gauge_addrs: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>

		'mint_many(address[8])'(gauge_addrs: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<void>

		mint_for(gauge_addr: PromiseOrValue<string>, _for: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>

		'mint_for(address,address)'(gauge_addr: PromiseOrValue<string>, _for: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>

		toggle_approve_mint(minting_user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>

		'toggle_approve_mint(address)'(minting_user: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>
	...
	estimateGas: {
		mint(gauge_addr: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>

		'mint(address)'(gauge_addr: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>

		mint_many(gauge_addrs: PromiseOrValue<string>[], overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
		...
		toggle_approve_mint(minting_user: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
	...
	populateTransaction: {
		mint(gauge_addr: PromiseOrValue<string>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
