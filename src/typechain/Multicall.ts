...
export interface MulticallInterface extends utils.Interface {
	...
	getFunction(
		nameOrSignatureOrTopic: 'aggregate' | 'aggregate((address,bytes)[])' | 'getEthBalance' | 'getEthBalance(address)',
	): FunctionFragment
	...
	encodeFunctionData(functionFragment: 'getEthBalance(address)', values: [PromiseOrValue<string>]): string
...
export interface Multicall extends BaseContract {
	...
	functions: {
		...
		'getEthBalance(address)'(addr: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber] & { balance: BigNumber }>
	}
	...
	'getEthBalance(address)'(addr: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>
	...
	populateTransaction: {
		...
		'getEthBalance(address)'(addr: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>
	}
}
