...
export interface SaddleLpInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'burnFrom(address,uint256)', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string
	...
	encodeFunctionData(functionFragment: 'mintedAmounts', values: [PromiseOrValue<string>]): string
	encodeFunctionData(functionFragment: 'mintedAmounts(address)', values: [PromiseOrValue<string>]): string
	...
	decodeFunctionResult(functionFragment: 'mintedAmounts(address)', data: BytesLike): Result
...
export interface SaddleLp extends BaseContract {
	...
	functions: {
		...
		mintedAmounts(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>

		'mintedAmounts(address)'(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber]>
	...
	estimateGas: {
		...
		'burn(uint256)'(amount: PromiseOrValue<BigNumberish>, overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
	...
	populateTransaction: {
		...
		mintedAmounts(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>

		'mintedAmounts(address)'(arg0: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>
