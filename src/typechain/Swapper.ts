...
export interface SwapperInterface extends utils.Interface {
	...
	getFunction(
		nameOrSignatureOrTopic: 'baoV1' | 'baoV1()' | 'baoV2' | 'baoV2()' | 'convertV1' | 'convertV1(address,uint256)',
	): FunctionFragment
	...
	encodeFunctionData(functionFragment: 'baoV2()', values?: undefined): string
	encodeFunctionData(functionFragment: 'convertV1', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string
	encodeFunctionData(functionFragment: 'convertV1(address,uint256)', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string
	...
	decodeFunctionResult(functionFragment: 'convertV1(address,uint256)', data: BytesLike): Result
...
export interface Swapper extends BaseContract {
	...
	callStatic: {
		...
		convertV1(_to: PromiseOrValue<string>, _amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>
