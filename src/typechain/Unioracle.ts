...
export interface UnioracleInterface extends utils.Interface {
	...
	encodeFunctionData(functionFragment: 'blockTimestampLast()', values?: undefined): string
	encodeFunctionData(functionFragment: 'consult', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string
	encodeFunctionData(functionFragment: 'consult(address,uint256)', values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string
	...
	decodeFunctionResult(functionFragment: 'consult(address,uint256)', data: BytesLike): Result
...
export interface Unioracle extends BaseContract {
	...
	functions: {
		...
		price0Average(overrides?: CallOverrides): Promise<[BigNumber] & { _x: BigNumber }>
		...
		price1Average(overrides?: CallOverrides): Promise<[BigNumber] & { _x: BigNumber }>
	...
	consult(token: PromiseOrValue<string>, amountIn: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>
	...
	populateTransaction: {
		...
		consult(token: PromiseOrValue<string>, amountIn: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>
