...
import type { BalancerWeightedPool, BalancerWeightedPoolInterface, WeightedPool } from '../BalancerWeightedPool'
...
export class BalancerWeightedPool__factory {
	...
	static connect(address: string, signerOrProvider: Signer | Provider): BalancerWeightedPool {
		return new Contract(address, _abi, signerOrProvider) as BalancerWeightedPool
	}
}
