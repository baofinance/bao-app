...
import type { SimpleUniRecipeETH, SimpleUniRecipeETHInterface } from '../SimpleUniRecipeETH'
...
export class SimpleUniRecipeETH__factory {
	...
	static connect(address: string, signerOrProvider: Signer | Provider): SimpleUniRecipeETH {
